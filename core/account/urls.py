...
#Url routing paths for the account application. 
urlpatterns = [
    path(
        "login/",
    ...
    path("profile/delete_user/", views.edit_details, name="delete_user"),
    path(
        "profile/delete_confirm/",
        TemplateView.as_view(template_name="account/dashboard/delete_confirm.html"),
        name="delete_confirmation",
    ),
    path("dashboard/save_review/<int:oid>/", views.save_review, name="save_review"),
]
